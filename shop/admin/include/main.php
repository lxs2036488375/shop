	...
	<body>
		...
		<div class="mainindex">
			...
			<div class="welinfo">
				...
				<b><?php echo $_SESSION['username']; ?>早上好，欢迎使用信息管理系统</b>(<?php echo $_SESSION['username']; ?>@uimaker.com)
				<a href="#">帐号设置</a>
			</div>
			...
			<ul class="infolist">
				<li><span>您可以快速发布会员</span><a href="../vip/index.php" class="ibtn">发布会员</a></li>
				<li><span>您可以快速发布产品</span><a href="../product/index.php" class="ibtn">发布产品</a></li>
				<li><span>您可以快速发布产品类别</span><a href="../type/index.php" class="ibtn">发布产品类别</a></li>
			</ul>
