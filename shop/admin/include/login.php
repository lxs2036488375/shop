    ...
    <div class="loginbody">
		...
		<div class="loginbox">
			...
			<ul>
				...
				<li><input name="pass" type="password" class="loginpwd" value="" onclick="JavaScript:this.value=''"/></li>
				<li>
				<input name="yzm" type="text" class="loginyzm" value="" onclick="JavaScript:this.value=''"/>
				<img src="./yzm.php" class="yzmpic" onClick="this.src='yzm.php?nocache='+Math.random()"  alt="验证码">
				</li>
