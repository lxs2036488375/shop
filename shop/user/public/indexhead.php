				...
				<div class="top_right">
					<ul>
						<?php if(empty($_SESSION['usernameu'])) { ?>
								<li><a href="./view/login.php" class="top_list">登录</a><span class="shu_line">|</span></li>
								<li><a href="./view/reg.php" class="top_list">注册</a><span class="shu_line">|</span></li>
						<?php } else { ?>
								<li><a href="./view/user.php" class="top_list"><?php echo $_SESSION['usernameu']; ?> </a><span class="shu_line">|</span></li>
								<li><a href="./controller/logout.php" class="top_list">退出</a><span class="shu_line">|</span></li>
						<?php } ?>
						<li><a href="#" class="top_list">消息通知</a></li>
					</ul>
					<a href="./view/cart.php" class="cart"><i class="icon"></i>购物车(<?php echo isset($_SESSION["num_he"])?$_SESSION["num_he"]:"0";  ?>)</a>
				</div>
			</div>
		</div>
		<!--主体白色背景部分-->
